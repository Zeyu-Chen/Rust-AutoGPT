...
const CODE_TEMPLATE_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../web-server/src/code_template.rs"
);

pub const WEB_SERVER_PROJECT_PATH: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../web-server/");

pub const EXEC_MAIN_PATH: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../web-server/src/main.rs");

const API_SCHEMA_PATH: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/schemas/api_schema.json");
